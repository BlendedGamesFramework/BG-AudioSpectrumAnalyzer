               ...
               OnItemClickListener, AnalyzerGraphic.Ready
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final AnalyzerActivity auxActivity = this;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@androidx.annotation.NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null){
                    ...
                    Toast.makeText(AnalyzerActivity.this,"Inicio de sesion exitosa",Toast.LENGTH_SHORT).show();
                    String FINAL_URL = GET_ID_PLAYER_URL+user.getEmail();
                    System.out.println(FINAL_URL);
                    Log.i("finalUrl",FINAL_URL);
                    RetrieveFeedTask m = (RetrieveFeedTask) new RetrieveFeedTask().execute(FINAL_URL);
                    Integer temp = -1;
                    try {
                    ...
                    System.out.println("tengo el id del jugador "+temp);
                    WebSocket websocket = new WebSocket(temp,auxActivity);
...
//            mFirebaseAuth = FirebaseAuth.getInstance();
        analyzerViews = new AnalyzerViews(this, mAuthListener);
    ...
    protected void onResume() {
        ...
        System.out.println(analyzerViews);
        LoadPreferences();
    ...
    public void logout(){
        AuthUI.getInstance().signOut(this).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@androidx.annotation.NonNull Task<Void> task) {
                Toast.makeText(AnalyzerActivity.this,"Sesion cerrada", Toast.LENGTH_SHORT).show();
